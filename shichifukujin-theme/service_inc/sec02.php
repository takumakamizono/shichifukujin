<div class="sl-service__sec02">
                    <div class="sl-service__sec02-inner">
                     ...
                     <div class="sl-service__sec02-desc">
                      ...
                      <p>施設の作成したタイムスケジュールに入居者様を合わせるのではなく、私たちが、入居者様のお一人お一人の生活リズムに合わせてケアをします。</p>
                      ...
                      <dl class="sl-service__sec02-dl">
                        ...
                        <dd>
                          ...
                          <ul>
                            <li>心身体操</li>
                            <li>活性温熱療法</li>
                            <li>フィンガースポーツ運動・フラハンド有酸素運動</li>
                            <li>ゲーゴールゲーム・ゲーゴールソフト</li>
                            <li>回想療法</li>                 
                          </ul>
                          <p>座ってでもできる簡単な体操や運動、（①③）、一人から多人数まで楽しめる簡単かつ奥の深いゲーム（④）、専用のヒーターを使用し体を温めながらマッサージを行うことで、全身の血行を促進し心や身体の緊張を和らげつつ、職員が利用者様一人一人の生活史にお邪魔しながらコミュニケーションをとっていきます（②⑤）。
<br>以上を総合的に組み合わせ、心身ともに活性化を促す取り組みです。</p>
                        </dd>
                      </dl>
                      </div>
                    <?php endif; ?>
