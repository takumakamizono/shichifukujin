<div class="texts-blocks">
                   ...
                   <?php if($post_slug === 'service_silkroad'): ?>
                     ...
                     <div class="text-box__desc">
                      ...
                      <dl class="text-box__dl">
                        <dt class="text-box__innerTitle">認知症改善プログラム</dt>
                        <dd>
...
<br>以上を総合的に組み合わせ、心身ともに活性化を促す取り組みです。</p>
                      ...
                      <div class="text-box__innerBox">
                        <h5 class="text-box__innerTitle">眠りスキャン</h5>
...
睡眠の状態だけでなく心拍数や呼吸数などを訪室しなくても確認できるので利用者様の眠りを妨げることなく、快適な夜を提供することができ、かつ利用者様の急変にもいち早く対応することができるシステムを導入しています。</p>
                      ...
                      <div class="text-box__innerBox">
                        <h5 class="text-box__innerTitle">アニマルセラピー</h5>
                        <div class="text-box__innerDesc">
                          <p>お部屋にいる入所者様の睡眠状態を把握することで、安心した介護ができています。 <br>
睡眠の状態だけでなく心拍数や呼吸数などを訪室しなくても確認できるので利用者様の眠りを妨げることなく、快適な夜を提供することができ、かつ利用者様の急変にもいち早く対応することができるシステムを導入しています。</p>
                        </div>
                      ...
                      <div class="text-box__innerBox">
                        <h5 class="text-box__innerTitle">薬膳料理</h5>
                        <div class="text-box__innerDesc">
                          <p>お部屋にいる入所者様の睡眠状態を把握することで、安心した介護ができています。 <br>
睡眠の状態だけでなく心拍数や呼吸数などを訪室しなくても確認できるので利用者様の眠りを妨げることなく、快適な夜を提供することができ、かつ利用者様の急変にもいち早く対応することができるシステムを導入しています。</p>
                        </div>
...
睡眠の状態だけでなく心拍数や呼吸数などを訪室しなくても確認できるので利用者様の眠りを妨げることなく、快適な夜を提供することができ、かつ利用者様の急変にもいち早く対応することができるシステムを導入しています。</p>
                      ...
                      <div class="text-box__innerBox">
                        <h5 class="text-box__innerTitle">看取り（施設で最期の日まで）</h5>
                        <div class="text-box__innerDesc">
                          <p>お部屋にいる入所者様の睡眠状態を把握することで、安心した介護ができています。 <br>
睡眠の状態だけでなく心拍数や呼吸数などを訪室しなくても確認できるので利用者様の眠りを妨げることなく、快適な夜を提供することができ、かつ利用者様の急変にもいち早く対応することができるシステムを導入しています。</p>
                        </div>
