...
<section class="overview">
 ...
 <table class="overview-table">
  ...
  <tr>
    <th>住所</th>
    <td>〒890-0082 鹿児島県鹿児島市紫原５-１３-１８</td>
  </tr>
  <tr>
    <th>電話番号</th>
    <td>099-256-2729</td>
  ...
  <tr>
    ...
    <td>099-256-3729</td>
                    ...
                    <div class="aboutpage-access__inner">
                        ...
                        <div class="aboutpage-access__text">
                            ...
                            <dl class="aboutpage-access__dl">
                                <dt>所在地</dt>
                                <dd>〒890-0082 鹿児島県鹿児島市紫原５-１３-１８</dd>
                                <dt>お車でお越しの方</dt>
                  ...
                  事業理念
                    ...
                    <div class="philosophy__sub">
                        <ul>
                            <li>１．私は、自分の親や大切な人を誇りをもって紹介したいと思える事業所をつくります。</li>
                            <li>２．私は、介護・福祉業界のイメージアップ新 3K(感謝・感動・カッコイイ)に貢献します。</li>
                            <li>３．私は、全職員の物心両面の豊かさと幸せを実現します。</li>
                        </ul>
                    </div>
                    </div>  
                      <div class="philosophy__block">
                  ...
                  <p class="content-subtitle">七福神の７つの心・２つの力・９つの行動</p>
                    ...
                    <div class="philosophy__sub">
                        <ul>
                            <li>１．愛の力 認め愛・支え愛・語り愛・喜び愛・許し愛</li>
                            <li>２．チームの力</li>
                        </ul>
                    </div>
                    </div>  
                    ...
                    <div class="philosophy__sub">
                        <ul>
                            <li>１．仕事を通して自己実現します。</li>
                            <li>２．利用者様主体のケア(利用者様ファースト)を追求します。</li>
                            <li>３．質の高いコミュニケーションを取ります。</li>
                            <li>４．質の高い思考と行動で効果性と効率性をあげます。</li>
                            <li>５．コンプライアンスと社会規範を遵守します。</li>
                            <li>６．クレームやヒヤリハットは情報の宝、真摯に改善につなげます。</li>
                            <li>７．プロフィットコストにするのかロスコストにするのかは自分次第です。</li>
                            <li>８．”真剣だと知恵が出る いい加減だと愚痴が出る 中途半端だと言い訳が出る”結果は能力の差ではなく意識の差だと考えます。</li>
                            <li>９．逃げずしゃがまずへこたれず、顔で笑って心で泣いてそれでも前に進みます。</li>
                        </ul>
                    </div>
                    </div>  
